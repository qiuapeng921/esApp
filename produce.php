...
return [
    ...
    'MAIN_SERVER' => [
        ...
        'SETTING' => [
            'worker_num' => 4, //8,//运行的  worker进程数量
            'max_request' => 1000, //5000,// worker 完成该数量的请求后将退出，防止内存溢出
            'task_worker_num' => 4, //8,//运行的 task_worker 进程数量
            'task_max_request' => 500, //1000,// task_worker 完成该数量的请求后将退出，防止内存溢出
            'reload_async' => true,
